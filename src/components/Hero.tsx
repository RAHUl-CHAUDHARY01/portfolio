    ...
    <div className="pt-12 w-full flex flex-col md:flex-row gap-6 md:gap-8 md:justify-between md:items-center relative">
      ...
      <div className="text-center md:text-left px-4 md:px-0 max-w-2xl text-black">
        ...
        <div className="flex flex-wrap gap-3 mt-2 justify-center md:justify-start items-center">
          <Link href="mailto:rahulchaudhary4509@gmail.com">
            <RainbowButton>
        ...
        <div className="flex flex-wrap gap-3 mt-3 justify-center md:justify-start items-center">
          <Link
            href={"https://x.com/RahulCh08908694"}
            target="_blank"
          >
          ...
          <Link href="https://github.com/RAHUl-CHAUDHARY01" target="_blank">
            <div className="border p-2 rounded-full shadow-sm">
              <GithubIcon size={15} />
            </div>
          </Link>
          <Link
            href={"https://www.linkedin.com/in/rahul-kumar-b31187214/"}
            target="_blank"
          >
            <div className="border p-2 rounded-full shadow-sm">
              <Linkedin size={15} />
