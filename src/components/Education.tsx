...
export default function Education(){
    return(
        <div className="flex flex-col items-center p-5 mt-5 w-full text-black">
            ...
            <div className="flex w-full items-center gap-5 mt-5">
                ...
                <div className="w-full">
                    <div className="flex justify-between items-center">
                        <div className="items-center gap-2"><h1 className="font-bold">Indian Institute of Information Technology Sonepat,Haryana</h1></div>
                        <h1 className="text-sm text-black/70">Graduating in June 2026</h1>
                    </div>
                    <span className="text-sm font-normal text-black/70">B.Tech in Information Technology</span>
                </div>
            </div>
            <div className="flex w-full items-center gap-5 mt-5">
                <div>
                ...
                <div className="w-full">
                    <div className="flex justify-between items-center">
                        ...
                        <h1 className="text-sm text-black/70">2022</h1>
                    </div>
